...
* [Repository](https://github.com/sxyazi/yazi) ⭐ 41,954 | 🐛 67 | 🌐 Rust | 📅 2026-09-01
...
> You can use [boydaihungst/gvfs.yazi](https://github.com/boydaihungst/gvfs.yazi) ⭐ 78 | 🐛 1 | 🌐 Lua | 📅 2026-08-29 instead.
...
> Check out [no-header.yazi](https://github.com/sxyazi/yazi/discussions/1996) ⭐ 41,954 | 🐛 67 | 🌐 Rust | 📅 2026-09-01 in this discussion.
...
Check out the [`checkout_more` section](https://github.com/AnirudhG07/awesome-yazi/tree/main/checkout_more) ⭐ 768 | 🐛 2 | 🌐 Shell | 📅 2026-08-23 for more cool stuff and plugins. If you want to add something cool you made, which is not a plugin, flavor or theme, you can definitely add it to the `checkout_more` section for others to see.
